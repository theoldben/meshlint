#Mesh Lint - Checks the Mesh for a Set of Clean-Up Conditions, Counts and Highlights the Result.
...
bl_info = {
    ...
    "description": "Check objects for: Tris / Ngons / Nonmanifoldness / Poles etc.",
    "warning": "",
...
# Look for the "seeing error text"s, below. Something is super-fishy, but this
# is the workaround.
try:
    import bpy
    import bmesh
    import time
    import re
    # from MeshLintAnalyzer.py import MeshLintAnalyzer
    # from MeshLintContinuousChecker.py import MeshLintContinuousChecker
    # from MeshLintVitalizer.py import MeshLintVitalizer
    # from MeshLintObjectLooper.py import MeshLintObjectLooper
    # from MeshLintSelector.py import MeshLintSelector
    # from MeshLintObjectDeselector.py import MeshLintObjectDeselector
    # from MeshLintControl.py import MeshLintControl
    # from TestControl.py import TestControl
    # from TestUtilities.py import TestUtilities
    # from TestAnalysis.py import TestAnalysis
    # from MockBlenderObject.py import MockBlenderObject
    # from TestUI.py import TestUI
    # from QuietOnSuccessTestResult.py import QuietOnSuccessTestResult
    # from QuietTestRunner.py import QuietTestRunner
    ...
    class MeshLintAnalyzer:
        ...
        CHECKS.append({
            'symbol': 'five_poles',
            'label': '5-edge Poles',
            'definition': 'A vertex with 5 edges connected to it. Not an error, but useful to select since the cause direction changes in Edge-Loops',
            'default': False
        })
        ...
        CHECKS.append({
            'symbol': 'three_poles',
            'label': '3-edge Poles',
            'definition': 'A vertex with 3 edges connected to it. Not an error, but useful to select since the cause direction changes in Edge-Loops',
            'default': False
        })
    ...
    class MirrorVertsCheck(self, context):
        ...
        # Check if Mirror Modifier is present
